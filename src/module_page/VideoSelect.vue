<template>
    ...
    <div class="modal fade" id="modal-videoselect" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="block block-themed block-transparent remove-margin-b">
                    ...
                    <div class="block-content">
                        <select class="image-picker" data-limit="1" multiple="multiple">
...
export default {
    ...
    methods: {
        ...
        ok: function () {
            ...
            let _gridStackSelectItemId = this.$mem.state.gridStackSelectItemId;
            let customPros = _customProperties.get(_gridStackSelectItemId);
            let _video = $(".image-picker").val();
            console.log(_video);
            if(_video){
                customPros.video = _video[0];
            }else{
                customPros.video = undefined;
            }
